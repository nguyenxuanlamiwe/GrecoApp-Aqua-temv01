...
class _TBControlSystemPageState extends State<TBControlSystemPage> {
  ...
  List<_ControlSystemTab> get _displayTabs => [
        ...
        if (_currentSystem.hyrdromets.isNotEmpty) _ControlSystemTab.hyrdromets,
        _ControlSystemTab.forecast,
        if (_currentSystem.camera.isNotEmpty) _ControlSystemTab.camera,
        if (_currentSystem.groups.isNotEmpty) _ControlSystemTab.suggestion,
      ];
