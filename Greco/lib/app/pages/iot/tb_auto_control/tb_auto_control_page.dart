...
class _TBAutoControlPageState extends State<TBAutoControlPage> {
  ...
  Widget _listWidget() {
    var steps = _modesMap[_currentATSys?.moId]?.steps ?? [];
      ...
      child: Column(
        ...
        children: [
          ...
          if (_currentATSys?.safeAtpress != null)
            _doubleTextWidget(
                'Áp suất tối đa:', "${_currentATSys?.safeAtpress ?? 0}(bar)"),
          if (atMode != null)
          ...
          children: [
            Expanded(
              child: ElevatedButton.icon(
                onPressed: () {
                  _vm.input.autoEnable.add(!isAutoEnable);
                },
                icon: Icon(
            ...
            Expanded(
              child: ElevatedButton.icon(
                onPressed: isAutoEnable
                    ? () {
                        _vm.input.autoPauseEnable.add(!isAutoPauseEnable);
                      }
                    : null,
                icon: Icon(
                  isAutoPauseEnable
