...
class TBAssignBooleanStepWidget extends StatefulWidget {
  final TBATStep step;
  final TBControlSystem system;
  const TBAssignBooleanStepWidget({
    super.key,
    required this.step,
  ...
  @override
  State<TBAssignBooleanStepWidget> createState() =>
      _TBAssignBooleanStepWidgetState();
}

class _TBAssignBooleanStepWidgetState extends State<TBAssignBooleanStepWidget> {
  late final _titleTextController =
      TextEditingController(text: widget.step.name);

  TBAssignBooleanAction get _action =>
      widget.step.action as TBAssignBooleanAction;

  late var _selectedComponent = widget.system.booleanComponents
    ...
    final result = await showModalBottomScrollableSheet<Set<TBComponent>>(
      ...
      bodyBuilder: (context, scrollController) {
        return BottomSheetPickerPage<TBComponent>(
          ...
          loader: PassthroughListLoader(widget.system.booleanComponents),
          selectedElements: {
